...
type IconProps = {
  name: 'chevron-down' | 'plus' | 'minus' | 'share' | 'instagram' | 'facebook' | 'twitter' | 'menu' | 'x';
  className?: string;
};
