...
export const products: Product[] = [
  {
    ...
    colors: [{ name: 'color_oatmeal', hex: '#E2D5C3' }, { name: 'color_charcoal', hex: '#595959' }, { name: 'color_navy', hex: '#3A485E' }],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_light_grey', hex: '#D3D3D3' }, { name: 'color_camel', hex: '#C19A6B' }, { name: 'color_black', hex: '#000000' }],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_espresso', hex: '#4B3621' }, { name: 'color_heather_grey', hex: '#B2B2B2' }],
    sizes: ["M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_cream', hex: '#FFFDD0' }, { name: 'color_dusty_rose', hex: '#DCAE96' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_beige', hex: '#F5F5DC' }, { name: 'color_grey', hex: '#808080' }],
    sizes: ["One Size"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_charcoal', hex: '#595959' }],
    sizes: ["30", "32", "34", "36"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_forest_green', hex: '#228B22' }, { name: 'color_mustard', hex: '#FFDB58' }],
    sizes: ["One Size"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_black', hex: '#000000' }, { name: 'color_brown', hex: '#8B4513' }],
    sizes: ["S", "M", "L"],
    ...
    colors: [{ name: 'color_light_pink', hex: '#FFB6C1' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_cream', hex: '#FFFDD0' }],
    sizes: ["One Size"],
    ...
    colors: [{ name: 'color_ivory', hex: '#FFFFF0' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_sand', hex: '#C2B280' }],
    sizes: ["M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_black', hex: '#000000' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_heather_grey', hex: '#B2B2B2' }],
    sizes: ["S/M", "M/L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_oatmeal', hex: '#E2D5C3' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_camel', hex: '#C19A6B' }],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_navy', hex: '#3A485E' }],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    colors: [{ name: 'color_olive_green', hex: '#556B2F' }],
    sizes: ["M", "L", "XL"],
